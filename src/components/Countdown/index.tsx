...
export const Countdown: React.FC<CountdownProps> = ({ date, className }) => {
  ...
  const countdownRenderer = ({
    ...
    // Render a countdown
    if (days) {
      return t('voteProposalUi.countdownFormat.daysIncluded', {
        days,
        hours,
        minutes,
        seconds,
    ...
    if (hours) {
      return t('voteProposalUi.countdownFormat.hoursIncluded', {
        hours,
        minutes,
        seconds,
      });
    ...
    if (minutes) {
      return t('voteProposalUi.countdownFormat.minutesIncluded', {
        minutes,
        seconds,
      });
    }

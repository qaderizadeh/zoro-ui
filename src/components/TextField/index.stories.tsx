...
export const Default = () => (
  <TextField placeholder='0.0' type='number' min={0} />
);

export const WithLabel = () => (
  <TextField label='Label' placeholder='0.0' type='number' min={0} />
);
...
export const WithIsSmall = () => (
  <TextField placeholder='0.0' type='number' min={0} isSmall />
);
...
export const WithRightAdornment = () => (
  <TextField
    rightAdornment={<Button>Safe max</Button>}
    placeholder='0.0'
    type='number'
    min={0}
  />
...
export const Disabled = () => (
  <TextField placeholder='0.0' type='number' min={0} disabled />
);

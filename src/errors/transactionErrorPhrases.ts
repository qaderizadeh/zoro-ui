...
> = {
  ...
  INSUFFICIENT_BALANCE_FOR_VAI: t(
    'transactionErrors.insufficientBalanceForVai'
  ),
  ...
  SET_PENDING_ADMIN_OWNER_CHECK: t(
    'transactionErrors.setPendingAdminOwnerCheck'
  ),
  ...
  SET_VAICONTROLLER_OWNER_CHECK: t(
    'transactionErrors.setVaiControllerOwnerCheck'
  ),
  ...
  TOKEN_INSUFFICIENT_ALLOWANCE: t(
    'transactionErrors.tokenInsufficientAllowance'
  ),
  ...
  BORROW_ACCRUE_INTEREST_FAILED: t(
    'transactionErrors.borrowAccrueInterestFailed'
  ),
  ...
  BORROW_COMPTROLLER_REJECTION: t(
    'transactionErrors.borrowComptrollerRejection'
  ),
  ...
  REDEEM_ACCRUE_INTEREST_FAILED: t(
    'transactionErrors.redeemAccrueInterestFailed'
  ),
  REDEEM_COMPTROLLER_REJECTION: t(
    'transactionErrors.redeemComptrollerRejection'
  ),
  ...
  REPAY_BORROW_FRESHNESS_CHECK: t(
    'transactionErrors.repayBorrowFreshnessCheck'
  ),
  ...
  REDEEM_FEE_CALCULATION_FAILED: t(
    'transactionErrors.redeemFeeCalculationFailed'
  ),
  ...
  VAI_LIQUIDATE_FRESHNESS_CHECK: t(
    'transactionErrors.vaiLiquidateFreshnessCheck'
  ),
